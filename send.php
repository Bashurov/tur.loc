...
$address = "Lanatur3913@mail.ru";
$message = "Письмо с сайта Лана-Тур: ".$text_message."\nС уважением, ".$name."\nМой контактный e-mail: ".$email."";
...
<table width='600' height='300' align='center'>
 ...
 <div align='center' class='warning_font' align='left'>Ваше письмо доставлено в туристическое агенство Лана-Тур.<br /> Через некоторое время Вы получите ответ!</div>
